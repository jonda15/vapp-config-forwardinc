...
CREATE TABLE `approval` (
  ...
  `actionName` varchar(4000) DEFAULT NULL,
...
CREATE TABLE `approval_reqinvocoperation` (
  ...
  CONSTRAINT `FK_jojlwekd3on60hlhassgtpkd1` FOREIGN KEY (`reqInvocationOperation_id`) REFERENCES `request` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clientdata` (
  ...
  KEY `FK_phnvtrryop7muuuqscyhe4h5a` (`extension_id`),
  CONSTRAINT `FK_phnvtrryop7muuuqscyhe4h5a` FOREIGN KEY (`extension_id`) REFERENCES `extensions` (`id`)
...
INSERT INTO `clientdata` VALUES ('EXTENSION',1,'SIGMA_CLIENT','guiconf',NULL,1);
...
INSERT INTO `configuration` VALUES (1,'2015-11-04 11:12:45','sm_user','SSO User ID header','SSO User ID header'),(2,'2015-11-04 11:12:45','false','Enable SSO','Enable SSO'),(3,'2015-11-04 11:12:45','../app/','Logout URL','Logout URL'),(4,'2015-11-04 11:12:45','c:\\temp\\plugin','PluginDir','PluginDir'),(5,'2015-11-04 11:12:45','4','logging level','logging level'),(6,'2015-11-04 11:12:45','false','Enable Risk','Enable Risk'),(7,'2015-11-04 11:12:45','','FileUpload Root','FileUpload Root'),(8,'2015-11-04 11:12:45','No Risk, Low RIsk, Medium Risk, High Risk, Very High Risk','Risk Rule Thresholds Names','Risk Rule Thresholds Names'),(9,'2015-11-04 11:12:45','(24)XaBmTmRYjUNhIicPB5A/qg==FiyuFKR1Ojq1s5N/msLdxg==','IM USER Password','IM USER Password'),(10,'2015-11-04 11:12:45','10','logging interval','logging interval'),(11,'2015-11-04 11:12:45','false','Debug Mode','Debug Mode'),(12,'2015-11-04 11:12:45','5000000','MaxUploadSize','MaxUploadSize'),(13,'2015-11-04 11:12:45','false','Require Second Factor On Login','Require Second Factor On Login'),(14,'2015-11-04 11:12:45','200','MAX REQUESTS TO FETCH','MAX REQUESTS TO FETCH'),(15,'2015-11-04 11:12:45','0,20,40,60,80,100','Risk Rule Thresholds','Risk Rule Thresholds'),(16,'2015-11-04 11:12:45','false','Second Factor Enabled','Second Factor Enabled'),(17,'2015-11-04 11:12:45','sigma','IM USER','IM USER'),(18,'2015-11-04 11:12:45','None','logging users','logging users'),(19,'2015-11-04 11:12:45','0','Temp file lifetime','Temp file lifetime');
...
INSERT INTO `connector` VALUES (1,'2015-11-04 13:20:06','IDM','CONNECTOR_IDM','com.idmlogic.sigma.connector.ca.CaimAdapter',NULL,0x01,NULL,NULL),(2,'2015-11-11 10:51:02','GM','CONNECTOR_GM','com.idmlogic.sigma.connector.ca.gm.GmAdapter',NULL,0x00,NULL,NULL);
...
CREATE TABLE `extensions` (
  ...
  `extensionStr` longtext NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `extensions` VALUES (1,'2015-11-04 13:29:28','SIGMA_CLIENT',1,'CLIENT_DATA','{\"uniqueName\":\"SIGMA_CLIENT\",\"extensions\":[{\"uniqueName\":\"USER_LINE_MAP\",\"pairs\":{\"search_result_bottom\":\"{Email}, UserID:{UserId}\",\"approval_details\":\"{FirstName} {LastName}\",\"approval_table\":\"{FirstName} {LastName}\",\"user_selector_displayname\":\"{FirstName} {LastName}\",\"dashboard_approvals\":\"{FirstName} {LastName}\",\"user_dialog_info1\":\"{Phone}\",\"user_dialog_info2\":\"{City}\",\"user_dialog_info3\":\"{Email}\",\"user_email\":\"{Email}\",\"approval_details_user\":\"{FirstName} {LastName}\",\"user_displayname\":\"{FirstName} {LastName}\",\"user_title\":\"{Title}\",\"approval_details_requester\":\"{FirstName} {LastName} ({UserId})\",\"user_phone\":\"{Phone}\",\"penders_display\":\"{FirstName} {LastName}\",\"user_manager\":\"{Manager}\",\"search_result\":\"{FirstName} {LastName} --- Title: {Title}\",\"bulk_upload_attributes\":\"UserId,Email\",\"namedquery_<subordinates>\":\"UserId,UserId\",\"strict_cart_mode\":\"false\",\"risk_max_level\":\"1000\",\"hide_non_scoped_current_perms\":\"false\"}},{\"uniqueName\":\"USER_INFO_TABLE_HEADERS\",\"pairs\":{\"Name\":\"Name\",\"City\":\"City\",\"User ID\":\"User ID\"}},{\"uniqueName\":\"USER_INFO_TABLE_CELLS\",\"pairs\":{\"{FirstName} {LastName}\":\"{FirstName} {LastName}\",\"{City}\":\"{City}\",\"{UserId}\":\"{UserId}\"}},{\"uniqueName\":\"SIMILAR_USER_TABLE_HEADERS\",\"pairs\":{\"Name\":\"Name\",\"City\":\"City\",\"User ID\":\"User ID\"}},{\"uniqueName\":\"SIMILAR_USER_TABLE_CELLS\",\"pairs\":{\"{FirstName} {LastName}\":\"{FirstName} {LastName}\",\"{City}\":\"{City}\",\"{UserId}\":\"{UserId}\"}},{\"uniqueName\":\"USER_FULL_INFO_TABLE_HEADERS\",\"pairs\":{\"Name\":\"Name\",\"City\":\"City\",\"User ID\":\"User ID\"}},{\"uniqueName\":\"USER_FULL_INFO_TABLE_CELLS\",\"pairs\":{\"{FirstName} {LastName}\":\"{FirstName} {LastName}\",\"{City}\":\"{City}\",\"{UserId}\":\"{UserId}\"}},{\"uniqueName\":\"GROUP_LINE_MAP\",\"pairs\":{\"group_displayname\":\"{Group Name}\",\"approval_table\":\"{Group Name}\",\"approval_details\":\"{Group Name}\"}},{\"uniqueName\":\"GROUP_INFO_TABLE_HEADERS\",\"pairs\":{\"Name\":\"Name\"}},{\"uniqueName\":\"GROUP_INFO_TABLE_CELLS\",\"pairs\":{\"{Group Name}\":\"{Group Name}\"}}]}');
...
--
-- Table structure for table `historical_form`
--

DROP TABLE IF EXISTS `historical_form`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historical_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entityId` int(11) NOT NULL,
  `entityType` varchar(255) NOT NULL,
  `md5` varchar(255) NOT NULL,
  `serializedClone` longtext NOT NULL,
  PRIMARY KEY (`id`),
  KEY `formHisIndex` (`entityType`,`entityId`,`md5`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historical_form`
--

LOCK TABLES `historical_form` WRITE;
/*!40000 ALTER TABLE `historical_form` DISABLE KEYS */;
/*!40000 ALTER TABLE `historical_form` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historical_formprop`
--

DROP TABLE IF EXISTS `historical_formprop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historical_formprop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entityId` int(11) NOT NULL,
  `entityType` varchar(255) NOT NULL,
  `md5` varchar(255) NOT NULL,
  `serializedClone` longtext NOT NULL,
  PRIMARY KEY (`id`),
  KEY `formpropHisIndex` (`entityType`,`entityId`,`md5`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historical_formprop`
--

LOCK TABLES `historical_formprop` WRITE;
/*!40000 ALTER TABLE `historical_formprop` DISABLE KEYS */;
/*!40000 ALTER TABLE `historical_formprop` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historical_locale`
--

DROP TABLE IF EXISTS `historical_locale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historical_locale` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `entityId` int(11) NOT NULL,
  `entityType` varchar(255) NOT NULL,
  `localizationStr` longtext NOT NULL,
  `md5` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `localHisIndex` (`entityType`,`entityId`,`md5`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historical_locale`
--

LOCK TABLES `historical_locale` WRITE;
/*!40000 ALTER TABLE `historical_locale` DISABLE KEYS */;
/*!40000 ALTER TABLE `historical_locale` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historical_model`
--

DROP TABLE IF EXISTS `historical_model`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `historical_model` (
  ...
  `serializedClone` longtext NOT NULL,
  PRIMARY KEY (`id`),
  KEY `modelHisIndex` (`entityType`,`entityId`,`md5`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historical_model`
--

LOCK TABLES `historical_model` WRITE;
/*!40000 ALTER TABLE `historical_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `historical_model` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `languages` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_eg6gnnvd5v473wurbxh7r9tms` (`locale`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `languages` VALUES (1,0x01,'en');
...
INSERT INTO `profile` VALUES (1,'2015-11-04 13:27:24','ForwardIncProfile',0x01,'ForwardIncTag','{\"modules\":{\"dashboard\":true,\"tasks\":true,\"approvals\":true,\"implementations\":true,\"certificationCampaigns\":true,\"access\":true,\"myRequests\":true,\"myProfile\":true},\"features\":{\"favorites\":true,\"links\":true,\"scrollingAnimations\":true,\"commentsInRequestSummary\":true,\"showRequestHistory\":true,\"drafts\":true,\"settings\":true}}',NULL,NULL);
...
CREATE TABLE `request` (
  ...
  `parentRequestId` int(11) DEFAULT NULL,
  ...
  `backendResult_id` int(11) DEFAULT NULL,
  `invocationClone_id` int(11) DEFAULT NULL,
  `invocationLocalizationClone_id` int(11) DEFAULT NULL,
  `requestForm_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_65yyl5rbxiqt00jjrkamu15yr` (`requestBasket_id`),
  KEY `FK_mq98x4nuyp8rmsjbc9nra8qj9` (`requestInvocationOperation_id`),
  KEY `FK_so0717wx5nrvatjecmrc73yj2` (`backendResult_id`),
  KEY `FK_rso5kerqfdhwpg3pcr3k6jg68` (`invocationClone_id`),
  KEY `FK_b0ybx3e75bkvw4ndmi9abrhxb` (`invocationLocalizationClone_id`),
  KEY `FK_t6ftvh8b8lgsedm1ui0hx8wxu` (`requestForm_id`),
  CONSTRAINT `FK_t6ftvh8b8lgsedm1ui0hx8wxu` FOREIGN KEY (`requestForm_id`) REFERENCES `requestform` (`id`),
  CONSTRAINT `FK_65yyl5rbxiqt00jjrkamu15yr` FOREIGN KEY (`requestBasket_id`) REFERENCES `request` (`id`),
  CONSTRAINT `FK_b0ybx3e75bkvw4ndmi9abrhxb` FOREIGN KEY (`invocationLocalizationClone_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_mq98x4nuyp8rmsjbc9nra8qj9` FOREIGN KEY (`requestInvocationOperation_id`) REFERENCES `request` (`id`),
  CONSTRAINT `FK_rso5kerqfdhwpg3pcr3k6jg68` FOREIGN KEY (`invocationClone_id`) REFERENCES `historical_model` (`id`),
  CONSTRAINT `FK_so0717wx5nrvatjecmrc73yj2` FOREIGN KEY (`backendResult_id`) REFERENCES `request_backend` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `request_account` (
  ...
  `endpoint_clone_id` int(11) DEFAULT NULL,
  `endpoint_locale_id` int(11) DEFAULT NULL,
  `backendResult_id` int(11) DEFAULT NULL,
  `basket_id` int(11) DEFAULT NULL,
  `requestForm_id` int(11) DEFAULT NULL,
  `entitlement_clone_id` int(11) DEFAULT NULL,
  `entitlement_locale_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_hit5hv6v70ktbjk29nfqg0v5v` (`endpoint_clone_id`),
  KEY `FK_nqfgdig8c82mwo3v7jfd3g1hw` (`endpoint_locale_id`),
  KEY `FK_jvafykq7bt04xg0t0tlta8jrb` (`backendResult_id`),
  KEY `FK_e9rrhgya70ecjobla8muna6u1` (`basket_id`),
  KEY `FK_me20lyroxfxul3w0myd9buvha` (`requestForm_id`),
  KEY `FK_ricbd1kcyj9s0s77hj09e51mc` (`entitlement_clone_id`),
  KEY `FK_lj5x059qsbv2iwvg3xgd3topb` (`entitlement_locale_id`),
  CONSTRAINT `FK_lj5x059qsbv2iwvg3xgd3topb` FOREIGN KEY (`entitlement_locale_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_e9rrhgya70ecjobla8muna6u1` FOREIGN KEY (`basket_id`) REFERENCES `request` (`id`),
  CONSTRAINT `FK_hit5hv6v70ktbjk29nfqg0v5v` FOREIGN KEY (`endpoint_clone_id`) REFERENCES `historical_model` (`id`),
  CONSTRAINT `FK_jvafykq7bt04xg0t0tlta8jrb` FOREIGN KEY (`backendResult_id`) REFERENCES `request_backend` (`id`),
  CONSTRAINT `FK_me20lyroxfxul3w0myd9buvha` FOREIGN KEY (`requestForm_id`) REFERENCES `requestform` (`id`),
  CONSTRAINT `FK_nqfgdig8c82mwo3v7jfd3g1hw` FOREIGN KEY (`endpoint_locale_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_ricbd1kcyj9s0s77hj09e51mc` FOREIGN KEY (`entitlement_clone_id`) REFERENCES `historical_model` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `request_backend`
--

DROP TABLE IF EXISTS `request_backend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `request_backend` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rootId` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `UK_5f5jj1g6i3016g7313irkt0tx` (`backendRequestId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `request_backend`
--

LOCK TABLES `request_backend` WRITE;
/*!40000 ALTER TABLE `request_backend` DISABLE KEYS */;
/*!40000 ALTER TABLE `request_backend` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `request_backend_msg`
--

DROP TABLE IF EXISTS `request_backend_msg`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `request_backend_msg` (
  `req_backend_id` int(11) NOT NULL,
  `messages` varchar(255) DEFAULT NULL,
  KEY `FK_p0tswcbbm0x0jlb8cqkjerkf9` (`req_backend_id`),
  CONSTRAINT `FK_p0tswcbbm0x0jlb8cqkjerkf9` FOREIGN KEY (`req_backend_id`) REFERENCES `request_backend` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `request_backend_msg`
--

LOCK TABLES `request_backend_msg` WRITE;
/*!40000 ALTER TABLE `request_backend_msg` DISABLE KEYS */;
/*!40000 ALTER TABLE `request_backend_msg` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `request_targets`
--
...
CREATE TABLE `request_targets` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_jpc4p4y8foind0qlg874xpmry` (`request_id`),
  CONSTRAINT `FK_jpc4p4y8foind0qlg874xpmry` FOREIGN KEY (`request_id`) REFERENCES `request` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `request_targets`
--

LOCK TABLES `request_targets` WRITE;
/*!40000 ALTER TABLE `request_targets` DISABLE KEYS */;
/*!40000 ALTER TABLE `request_targets` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `requestform` (
  ...
  `formDefClone_id` int(11) DEFAULT NULL,
  `formDefLocalization_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_md10c2b705ik6p8qmbatr200a` (`formDefClone_id`),
  KEY `FK_jf6wt6vysb66i5yn5nky864hk` (`formDefLocalization_id`),
  CONSTRAINT `FK_jf6wt6vysb66i5yn5nky864hk` FOREIGN KEY (`formDefLocalization_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_md10c2b705ik6p8qmbatr200a` FOREIGN KEY (`formDefClone_id`) REFERENCES `historical_form` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requestformpropertyvalues` (
  ...
  `cloneLocalization_id` int(11) DEFAULT NULL,
  `requestForm_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_l7hw0xe4oemo70oyr6nhipd0l` (`clone_id`),
  KEY `FK_94n2yuv8jjhc1k61l1p5a50pv` (`cloneLocalization_id`),
  KEY `FK_d09so5h3546gboippmoqmalni` (`requestForm_id`),
  CONSTRAINT `FK_d09so5h3546gboippmoqmalni` FOREIGN KEY (`requestForm_id`) REFERENCES `requestform` (`id`),
  CONSTRAINT `FK_94n2yuv8jjhc1k61l1p5a50pv` FOREIGN KEY (`cloneLocalization_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_l7hw0xe4oemo70oyr6nhipd0l` FOREIGN KEY (`clone_id`) REFERENCES `historical_formprop` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requestpermission` (
  ...
  `status` varchar(255) DEFAULT NULL,
  `basket_id` int(11) DEFAULT NULL,
  `permissionClone_id` int(11) DEFAULT NULL,
  `permissionLocalization_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_ev5p6aysip7futt92uqt940ak` (`basket_id`),
  KEY `FK_h8nyyk0j9on40woooqy0wfvb3` (`permissionClone_id`),
  KEY `FK_q9qg2ndpk0b34b4wl18vblfp4` (`permissionLocalization_id`),
  CONSTRAINT `FK_q9qg2ndpk0b34b4wl18vblfp4` FOREIGN KEY (`permissionLocalization_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_ev5p6aysip7futt92uqt940ak` FOREIGN KEY (`basket_id`) REFERENCES `request` (`id`),
  CONSTRAINT `FK_h8nyyk0j9on40woooqy0wfvb3` FOREIGN KEY (`permissionClone_id`) REFERENCES `historical_model` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requesttargetpermission` (
  ...
  `targetPermissionClone_id` int(11) DEFAULT NULL,
  `targetPermissionResult_id` int(11) DEFAULT NULL,
  `taskDefClone_id` int(11) DEFAULT NULL,
  `taskDefResult_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_9w4mv1xu7evo1i6j30wpe9ugd` (`requestFrom_id`),
  KEY `FK_l9k8dg3mw4omo3fpcuu9iut54` (`requestPermission_id`),
  KEY `FK_mnd3w7cybj4qc1fjyhyleclu7` (`targetPermissionClone_id`),
  KEY `FK_c51dj7ectekmdu0je3bwfr3in` (`targetPermissionResult_id`),
  KEY `FK_bs5m9d3tgufo79voeu8xdfqq2` (`taskDefClone_id`),
  KEY `FK_jcq80m90at8c65vqn8y09kgxg` (`taskDefResult_id`),
  CONSTRAINT `FK_jcq80m90at8c65vqn8y09kgxg` FOREIGN KEY (`taskDefResult_id`) REFERENCES `request_backend` (`id`),
  CONSTRAINT `FK_9w4mv1xu7evo1i6j30wpe9ugd` FOREIGN KEY (`requestFrom_id`) REFERENCES `requestform` (`id`),
  CONSTRAINT `FK_bs5m9d3tgufo79voeu8xdfqq2` FOREIGN KEY (`taskDefClone_id`) REFERENCES `historical_model` (`id`),
  CONSTRAINT `FK_c51dj7ectekmdu0je3bwfr3in` FOREIGN KEY (`targetPermissionResult_id`) REFERENCES `request_backend` (`id`),
  CONSTRAINT `FK_l9k8dg3mw4omo3fpcuu9iut54` FOREIGN KEY (`requestPermission_id`) REFERENCES `requestpermission` (`id`),
  CONSTRAINT `FK_mnd3w7cybj4qc1fjyhyleclu7` FOREIGN KEY (`targetPermissionClone_id`) REFERENCES `historical_model` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requestuserviolation` (
  ...
  `requestBasket_id` int(11) DEFAULT NULL,
  `riskRuleLocalization_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_747f4b90h6svh4rsvfq21v2pc` (`parentViolation_id`),
  KEY `FK_mlxh63lsrs1t3gelmuqxih54y` (`requestBasket_id`),
  KEY `FK_yjy640jnwbh7t2g9q228y8uq` (`riskRuleLocalization_id`),
  CONSTRAINT `FK_yjy640jnwbh7t2g9q228y8uq` FOREIGN KEY (`riskRuleLocalization_id`) REFERENCES `historical_locale` (`id`),
  CONSTRAINT `FK_747f4b90h6svh4rsvfq21v2pc` FOREIGN KEY (`parentViolation_id`) REFERENCES `requestuserviolation` (`id`),
  CONSTRAINT `FK_mlxh63lsrs1t3gelmuqxih54y` FOREIGN KEY (`requestBasket_id`) REFERENCES `request` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requserviolationobjentity` (
  ...
  `objectClone_id` int(11) DEFAULT NULL,
  `objectCloneLocalization_id` int(11) DEFAULT NULL,
  `requestUserViolation_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_gy8rxfcycvt31a4j2x04tfgg3` (`objectClone_id`),
  KEY `FK_t2tq5x1sqn28e09g98al7pkdj` (`objectCloneLocalization_id`),
  ...
  CONSTRAINT `FK_gy8rxfcycvt31a4j2x04tfgg3` FOREIGN KEY (`objectClone_id`) REFERENCES `historical_model` (`id`),
  CONSTRAINT `FK_t2tq5x1sqn28e09g98al7pkdj` FOREIGN KEY (`objectCloneLocalization_id`) REFERENCES `historical_locale` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sigmarole_properties`
--

DROP TABLE IF EXISTS `sigmarole_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sigmarole_properties` (
  `role_id` int(11) NOT NULL,
  `value` varchar(2048) DEFAULT NULL,
  `name` varchar(255) NOT NULL,
  PRIMARY KEY (`role_id`,`name`),
  CONSTRAINT `FK_rh2eq1c3moori9092jmhw3x87` FOREIGN KEY (`role_id`) REFERENCES `sigmarole` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sigmarole_properties`
--

LOCK TABLES `sigmarole_properties` WRITE;
/*!40000 ALTER TABLE `sigmarole_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `sigmarole_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `systemdata` VALUES (1,'V161');
...
-- Dump completed on 2015-11-11 10:52:39
